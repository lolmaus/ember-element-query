...
export default class Reporter {
  ...
  setupDOM() {
    ...
    this.$hidePassed
      .attr('checked', Url.queryString('hide_passed'))
    ...
    this.$coverage
      .attr('checked', Url.queryString("coverage"))
    ...
    this.$noTryCatch
      .attr('checked', Url.queryString("no_try_catch"))
...
function fragmentForTest(test) {
  ...
  if (test.state === 'passed') {
    ...
    $fragment.find('.dump').on('click', () => console.info(test.err.stack));
  }
